...
export const wayangEntries: WayangEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Ksatria perkasa berhati lurus, simbol keberanian dan kesetiaan tanpa basa-basi.",
    description:
      "Bima adalah putra kedua Pandu dan Kunti, lambang kekuatan dan ketulusan. Tubuhnya tinggi besar, suaranya menggelegar, sikapnya polos namun tegas. Ia hanya tunduk kepada Sang Hyang Tunggal dan tidak pernah menggunakan bahasa krama bahkan kepada dewa. Lakon 'Bima Bungkus' menceritakan kelahirannya yang dibungkus selaput, lalu dirobek oleh Gajah Sena hingga lahirlah ksatria perkasa. Senjata utamanya Gada Rujakpolo dan kuku Pancanaka — kuku ibu jari yang sanggup membelah gunung.",
  },
  {
    slug: "arjuna",
    name: "Arjuna",
    ...
    summary:
      "Pemanah ulung berparas rupawan, cerdas, dan terus mencari kesempurnaan jiwa.",
    description:
      "Arjuna, putra ketiga Pandu, dikenal sebagai ksatria paling tampan dan ahli memanah tanpa tanding. Ia murid kesayangan Resi Drona dan kekasih banyak dewi. Dalam Bhagavad Gita, ia menjadi penerima ajaran Krishna di tengah medan Kurusetra. Pasopati, panah pemberian Bathara Siwa, hanya digunakan untuk perkara yang benar-benar suci. Di balik kelembutan dan ketampanannya, Arjuna adalah perenung yang terus menyucikan diri lewat tapa.",
  },
  {
    slug: "nakula",
    name: "Nakula",
  ...
  },
  {
    ...
    summary:
      "Sulung Kurawa, raja Hastinapura yang ambisius dan keras kepala.",
    description:
      "Duryudana adalah putra sulung Prabu Destarata dan Dewi Gendari, pemimpin seratus Kurawa. Ia tumbuh dalam iri hati melihat keutamaan Pandawa, didorong oleh paman liciknya, Sengkuni. Ambisinya menguasai Hastinapura akhirnya membawa kerajaannya ke medan Kurusetra. Meski digambarkan sebagai antagonis, Duryudana memiliki sisi ksatria — ia menepati janji, menjamu sahabat dengan tulus, dan gugur di medan perang dengan kepala tegak menghadapi Bima.",
  },
  {
    slug: "sengkuni",
    name: "Sengkuni",
  ...
  },
  {
    ...
    summary:
      "Penjelmaan dewa yang turun ke dunia menjadi rakyat jelata, simbol kebijaksanaan tertinggi.",
    description:
      "Semar adalah tokoh khas pewayangan Jawa yang tidak ada dalam epos asli India. Ia sesungguhnya Bathara Ismaya, kakak Bathara Guru, yang menerima kutuk untuk turun ke dunia menjadi Punakawan. Tubuhnya pendek gemuk, namun kebijaksanaannya melampaui para dewa. Ia menjadi pamomong para ksatria utama — terutama Pandawa — dan kerap menyelesaikan persoalan yang tak sanggup dipecahkan oleh dewa-dewi. Semar adalah simbol bahwa rakyat kecil pun dapat menjadi tempat lahirnya kebenaran.",
  },
  {
    slug: "gareng",
    name: "Gareng",
  ...
  },
  {
    ...
    origin: "mahabharata",
    summary:
      "Permaisuri Pandawa, lambang kesetiaan, harga diri, dan kekuatan perempuan.",
    description:
